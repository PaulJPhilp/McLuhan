...
describe('MessageComponent', () => {
    it('should render user message with correct styling', () => {
        const message = createTestMessage({ role: 'user', content: 'Hello, world!' })
    ...
    it('should render system message with correct styling', () => {
        const message = createTestMessage({ role: 'system', content: 'System notification' })
    ...
    it('should align user messages to the right', () => {
        const message = createTestMessage({ role: 'user', content: 'Right aligned' })
    ...
    it('should align assistant messages to the left', () => {
        const message = createTestMessage({ role: 'assistant', content: 'Left aligned' })
    ...
    it('should align system messages to the left', () => {
        const message = createTestMessage({ role: 'system', content: 'System message' })
